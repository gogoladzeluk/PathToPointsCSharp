...
namespace PathToPointsCSharp
{
    internal class FileToPointsConverter
    {
        ...
        {
            var program = new FileToPointsConverter("/home/luka/Desktop/cat.svg");
        ...
        {
            /*
            vecListList = new List<List<Vector2>>{
                new List<Vector2>
                {
                    new Vector2(2,3),
                    new Vector2(4,5),
            ...
            */
            ...
            Console.WriteLine("new List<List<Vector2>> {");
            var counter = 0;
            foreach (var vecList in vecListList)
            {
                Console.WriteLine("    new List<Vector2> {");
                foreach (var vec in vecList)
                {
                    Console.WriteLine("        new Vector2(" + vec.X + "f, " + vec.Y + "f),");
                }
                Console.WriteLine("    },");
            }
            Console.WriteLine("};");
